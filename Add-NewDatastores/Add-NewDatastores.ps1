...
$url = "https://tegile.domain.org/zebi/api/v2/listProjects"
$method = "POST"
...
#$bytes = [System.Text.Encoding]::UTF8.GetBytes("sa14:password")
#$token = [System.Convert]::ToBase64String($bytes)
$headers = @{"Authorization"="Basic $token"; "Content-Type"="application/json"}
$url = "https://sip-tegile2.dpsk12.org/zebi/api/v2/listVolumes"
$method = "POST"
[System.Net.ServicePointManager]::ServerCertificateValidationCallback ={$TRUE}
[System.Net.ServicePointManager]::SecurityProtocol = [System.Net.SecurityProtocolType]::Tls12;
$parameters = "pool-b","zTemp1","true"
...
$esxName = "pdc-ucsvms01.dpsk12.org"
